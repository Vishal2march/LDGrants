				...
				<div class="col-lg-12">
					<table class="table table-bordered" id="checklisttable">
						...
						<input  type="button" value="Cover Page" class="btn btn-md btn-active btn-block"
										onclick="javascript:location.href='liInitialForms.do?item=coversheet&p=al';" /></td>
					...
					<td class="col-lg-2"><div  id="<s:property value="formType"/>Approved"
						...
						<input  type="button" value="Narrative" class="btn btn-md btn-active btn-block"
										onclick="javascript:location.href='liInitialForms.do?item=narrative&p=al';" /></td>
					...
					<td class="col-lg-2"><div  id="<s:property value="formType"/>Approved"
						...
						<tr>
										<td>
						<input  type="button" value="Coordination Partnering Organization" class="btn btn-md btn-active btn-block"
										onclick="javascript:location.href='liInitialForms.do?item=partinst&p=al';" /></td>
					...
					<td class="col-lg-2"><div  id="<s:property value="formType"/>Approved"
						...
						<input  type="button" value="Attachments/Uploads" class="btn btn-md btn-active btn-block"
										onclick="javascript:location.href='liInitialForms.do?item=attachment&p=al';" /></td>
					...
					<td class="col-lg-2"><div  id="<s:property value="formType"/>Approved"
						...
						<input  type="button" value="Certification Statement" class="btn btn-md btn-active btn-block"
										onclick="javascript:location.href='liInitialForms.do?item=certform&p=al';" /></td>
