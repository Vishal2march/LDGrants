...
<div class="panel panel-default">
	<div class="panel-heading">
	    <h2>Adult Literacy Final Narratives</h2>
	</div>
	<div class="panel-body">
		...
		<s:iterator value="narrativeTypeList" status="row">
			...
			<s:url var="narrativeUrl" action="literacySelectFinalNarrative">
...
<div class="panel panel-default">
	...
	<s:if test="selectedNarrative.narrativeTypeId>0">
		...
		<s:form action="literacySaveFinalNarrative" cssClass="form-vertical">
				
			<s:hidden name="selectedNarrative.id"/>
			<s:hidden name="selectedNarrative.narrativeTypeId"/>
				
			<%-- user with readonly access --%>
			<s:if test="%{#session.user.adultLiteracyAccess=='READ'}">
