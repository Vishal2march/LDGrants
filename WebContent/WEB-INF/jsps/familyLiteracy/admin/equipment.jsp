...
<script type="text/javascript">
    $(document).ready(function () {
        $('#EquipmentTableContainer').jtable({
            title: 'Family Literacy Admin - Equipment Year 1',
            footer: true,
            actions: {
                listAction: 'literacyYr1EquipmentList.action',
                createAction: 'addUpdateLiteracyEquipmentRowAdmin.action',
                //updateAction is supposed to only return "result", but reusing addupdate action seems to work ok
                updateAction: 'addUpdateLiteracyEquipmentRowAdmin.action',
