...
<script type="text/javascript">
    $(document).ready(function () {
        $('#SuppliesTableContainer').jtable({
            title: 'Family Literacy Admin - Supplies and Materials Year 1',
            footer: true,
            actions: {
                listAction: 'literacyYr1SuppliesList.action',
                createAction: 'addUpdateLiteracySuppliesRowAdmin.action',
                //updateAction is supposed to only return "result", but reusing addupdate action seems to work ok
                updateAction: 'addUpdateLiteracySuppliesRowAdmin.action',
