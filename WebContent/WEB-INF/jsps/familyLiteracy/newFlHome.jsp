	...
	<div class="col-md-8">
		...
		<s:else>
			...
			<input  type="button" value="Create Application" class="btn btn-success btn-lg"
				onclick="javascript:location.href='fmliteracyApplication.do?item=createapp&m=f';" />
	...
	<div class="col-md-8">
		<div class="panel panel-primary application-links">
			<div class="panel-heading">
				<i class="fa fa-sitemap"></i>My Family Literacy Projects
			</div>
	...
	<div class="col-md-4">
		<div class="panel panel-primary application-links">
			...
			<div class="panel-body">
				<ul>
					<li><a target="_blank"
						href="http://www.nysl.nysed.gov/libdev/familylit/index.html">Family
