...
<html>
  <head>
    ...
    <title>attachmentAdminDownload</title>
  </head>
  <body>
  ...
  <table border="1" class="graygrid" align="center" width="95%" summary="for layout only">
    ...
    <tr>
        <td colspan="7">
        <c:url value="writefileservlet" var="writeURL" >
          <c:param name="gid" value="${grantid}" />
        </c:url>    
       <%-- not working srv03 <a href="<c:out value="${writeURL}" />">Download</a> all attachments to folder --%></td>
    </tr>
  </table>
