...
<html>
  <head>
    ...
    <title>Public Library Construction - Reduce Match Form</title>
  </head>
  <body>
  ...
  <html:form action="/saveAdminCnJustification">  
  <table align="center" width="95%" class="boxtype" summary="for layout only">
    ...
    <c:when test="${thisGrant.fycode<15}"><%--before 2014-15; used justification narrative--%>   
        <tr>
            ...
            <html:textarea property="matchJustification" cols="80" rows="14" /></td>
        </tr>
    </c:when>
    <c:otherwise>
          <tr>
