...
<html>
 ...
 <p class="bdgtitle"><b>Project Budget<br/>
    ...
    All equipment to be purchased should be described in the 'Budget Narrative'.<br/><br/>
  ...
  <table width="100%" summary="for layout only">
    <tr>
      ...
      <td class="dibgt"><a href="BudgetSelect?tab=5&p=cn">Supplies & Materials</a></td> 
...
<a name="bdgcontent" id="bdgcontent" /><br/>
 ...
 <html:errors />
 <html:form action="/saveCnEquipExp" > 
