...
<p class="bdgtitle"><b>Project Budget<br/>
  ...
  <table width="100%" summary="for layout only">
    <tr>  
      ...
      <td class="dibgt">
      <a href="BudgetSelect?tab=6&p=cnrev">Equipment</a></td>       
  ...
  <html:errors />
  <html:form action="/saveCnContractReview" >
  ...
  <logic:notEmpty name="BudgetCollectionBean" property="allContractRecords">
      ...
      <c:when test="${ sgaSubmit=='true' }" > 
          <p align="center"><input type="BUTTON" value="Save Purchased Expenses" disabled="disabled" /></p>
      </c:when>
      <c:otherwise >
          <p align="center">
            <input type="HIDDEN" name="currtab" value="3" />
            <input type="HIDDEN" name="i" value="4" />
            <html:submit value="Save Purchased Expenses" /></p>
      </c:otherwise>
      </c:choose>
  </logic:notEmpty> 
 </html:form>
