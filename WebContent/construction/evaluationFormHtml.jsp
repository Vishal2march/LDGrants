...
<html>
  ...
  <h4>Public Library Construction Evaluation Form</h4>
  ...
  <table align="center" width="95%" border="1" summary="for layout only" >
    <tr>
        <td width="40%"><b>Does the library system deem the public library eligible 
             for a reduced match requirement below 50%?</b></td>
        <td width="60%"><c:out value="${assignBean.reduceMatchExists}" /></td>
    </tr>
