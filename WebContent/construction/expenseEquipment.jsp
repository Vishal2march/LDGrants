...
<html>
  <head>
    ...
    <title>Public Library Construction - Final Equipment Expenses</title>
  </head>
  <body>
  ...
  <%--read only after submission--%>
      ...
      <p align="center"><input type="hidden" name="mod" value="cn"/>
                         <input type="hidden" name="eid" value="20"/>
  ...
  <c:otherwise>
      ...
      <p>
        ...
        <INPUT type="hidden" name="c" value="20"> </p>
      </form>
