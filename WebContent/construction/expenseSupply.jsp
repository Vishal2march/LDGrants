...
<html>
  <head>
    ...
    <title>Public Library Construction - Final Supply Expenses</title>
  </head>
  <body>
  
  <p class="bdgtitle"><b>Final Budget Expense<br/>
  ...
  <table width="100%" summary="for layout only">
    <tr>  
      <td class="dibgt">
      <a href="cnFinalExpenseNav.do?i=selectexpense&c=40">Purchased Services</a></td>
  ...
  <c:otherwise> 
      ...
      <p>
        ...
        <INPUT type="hidden" name="c" value="45"> </p>
      </form>
        ...
        <c:url value="cnFinalExpenseNav.do" var="deleteURL">
          ...
          <tr>      
            ...
            <td width="20%"><html:text name="finalExpenseItem" property="expAmountStr" indexed="true" />
                ...
                <html:hidden name="finalExpenseItem" property="grantId" indexed="true" /></td>        
