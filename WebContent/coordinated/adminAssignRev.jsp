 ...
 * Name of the Application        :  adminAssignRev.jsp
 * Creation/Modification History  :
 *     
 *     SHusak       8/1/07     Created
 *
 * Description
 * This page allows the admin to view the reviewer assigned to this grant, add a reviewer
 * for this grant, and access reports on all reviewer availability and assignemnts. It also
 * has links to delete a reviewer assigned to this grant and asks to confirm before deleting.
--%>
  ...
  <c:otherwise >
    ...
    <table width="90%" align="center" class="boxtype" summary="for layout only">
      ...
      <tr>
        ...
        <td><a href="cpAdminReport.do?item=revcontact&fc=7" target="_blank">HTML Report</a></td>
      </tr>
      <%--<c:url var="revavail" value="ReportServlet">
        <c:param name="todo" value="availability" />
      ...
      <%--<c:url var="revassign" value="ReportServlet">
        <c:param name="todo" value="revassign" />
    ...
    <form method="POST" action="coAdminRevNav.do?item=assign">    
    <tr>
      ...
      <td>
        <table width="100%" summary="for layout only">
          ...
          <c:forEach var="assignBean" items="${allAssigned}" >
            <c:url var="deleteURL" value="AdminRevProcess.do">
