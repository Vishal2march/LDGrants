 ...
 * Name of the Application        :  adminRevEmail.jsp
 * Creation/Modification History  :
 *
 *     SH       8/15/07     Created
 *
 * Description
 * This page allows the co admin to send mass mailings to the reviewers, such
 * as the request for participation email. Not used anymore 3/27/13, now using sedems
--%>
...
<html>
  ...
  <br/>
    ...
    <form action="MassMailServlet" method="POST">
      ...
      <input type="HIDDEN" name="mod" value="co" />
      Do you want to send a Request for Participation Email to all Active Coordinated Reviewers?<br/>
    ...
    <table width="80%" align="center" class="boxtype" summary="for layout only">
      <tr>
        <td>Dear FNAME LNAME,<BR/><BR/>      
            ...
            Conservation/Preservation Coordinated Grant Program.  The program has always 
            relied heavily on the good will of preservation librarians, archivists, and 
            conservators to provide professional review to help ensure that projects funded 
            through the program are well planned, cost effective, and productive.<br/><br/>
    ...
    <table align="center" width="80%" summary="for layout only" >
      <tr>
        <th colspan="3">The following reviewers were assigned Coordinated grants for this fiscal year</th>
      </tr>
      <tr>
  ...
  <h4>Choose the email type to send to Coordinated Reviewers</h4>
  
  <p>These mass mailings will be sent to all Coordinated Reviewers in the Reviewer table who
  ...
  <table width="90%" align="center" class="boxtype" summary="for layout only">
    <tr>
      ...
      Coordinated Reviewers to login to the system and fill out the number of grant proposals they are
      willing to review for this fiscal year.  The email will also instruct them to update their
      contact information.</td>
    </tr>
    <tr>
      <td><input type="BUTTON" value="Send Participation Mail" onclick="document.location.href='AdminRevEmail.do?todo=participate'" /></td>
    </tr>
  </table>
  <br/><br/>
  ...
  <table width="90%" align="center" class="boxtype" summary="for layout only">
    <tr>
      ...
      Coordinated Reviewers of the grant project numbers they have been assigned to review.  The email will
