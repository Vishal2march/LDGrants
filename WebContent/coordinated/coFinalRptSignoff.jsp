 ...
 * Name of the Application        :  coFinalRptSignoff.jsp
...
<html>
  ...
  <table width="80%" align="center" border="1" class="graygrid" summary="for layout only">
    ...
    <tr>          
      <c:choose >
      <c:when test="${lduser.prgco=='read' || appStatus.finalsignoffyn=='true' || appStatus.pendingFinalRev=='true'}" >
  ...
  <input type="HIDDEN" name="currpage" value="coFinalSignoff" />
