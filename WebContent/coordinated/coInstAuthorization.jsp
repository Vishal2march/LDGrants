 ...
 * Name of the Application        :  coInstAuthorization.jsp
...
<html>
  <head>
    ...
    <title>State Aid - Institutional Authorization</title>
  </head>
  <body>  
 ...
 <fmt:formatDate var="todayDate" value="${now}" pattern="MM/dd/yyyy" />
  ...
  <table align="center" width="80%" class="boxtype" summary="for layout only"  >
    <tr >
      <td>The undersigned hereby give assurance to the New York State Education Department 
  ...
  <br/><br/><br/>     
    ...
    <%-- NEED TO GET LIBRARY DIRECTOR AND PRESERVATION OFFICER FROM SEDREF --%>   
    <table border="1" class="graygrid" width="80%" align="center" summary="for layout only">
      <tr>
    ...
    <input type="HIDDEN" name="currpage" value="coInstAuth" />
    <input type="hidden" name="p" value="co" />
   
   
    <table align="center">
      <c:choose >
      <c:when test="${lduser.prgco=='read' || appStatus.instauthyn=='true' || appStatus.pendingReview=='true'}" >
        <tr>
