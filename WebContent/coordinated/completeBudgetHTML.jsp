 ...
 * Name of the Application        :  completeBudgetHTML.jsp
...
<html>
  <head>
    ...
    <link href="css/StateAid.css" media="screen" rel="stylesheet" type="text/css" />
    <title>Coordinated Aid Project Budget</title>
  </head>
  <body>  
  
  <table align="center" width="70%" summary="for layout only">
    <tr>
  ...
  <tr>
    <td><h4>Budget Year 1 (<c:out value="${thisGrant.fiscalyear}" />)</h4></td>
  </tr>
  ...
  <tr>
    <td><h4>Budget Year 2 (<c:out value="${thisGrant.fiscalyear +1}" />)</h4></td>
  </tr>
    <c:set var="GrantReq" value="0" />
    <c:set var="AmtAppr" value="0" />
    <c:set var="ExpSubm" value="0" />
  ...
  <tr>
    <td><h4>Budget Year 3 (<c:out value="${thisGrant.fiscalyear +2}" />)</h4></td>
  </tr>
    <c:set var="GrantReq" value="0" />
    <c:set var="AmtAppr" value="0" />
    <c:set var="ExpSubm" value="0" />
