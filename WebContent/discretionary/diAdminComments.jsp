 ...
 * Name of the Application        :  diAdminComments.jsp
 * Creation/Modification History  :
 *
 *     SHusak       2/27/08     Created
 *
 * Description
 * This is DI admin page for updating, deleting, or sending admin comments in email
 * to the grant PM. 
--%>
...
<html>
  ...
  <c:when test="${param.todo!='view' }">
    ...
    <c:if test="${param.todo=='delete'}">
      ...
      <form method="POST" action="adminCommentNav.do?item=deletec" >
        ...
        <input name="p" type="HIDDEN" value="di"/>
  ...
  <table align="center" width="90%" border="1" summary="for layout only">    
    ...
    <c:forEach var="commBean" items="${allComments}" >
      <c:url value="DiAdminComments.do" var="deleteURL">
    ...
    <tr>
      <td colspan="5" align="center"><input name="p" type="HIDDEN" value="di"/>
  ...
  <p>
    <a href="adminEmailNav.do?item=emails&m=di">View Emails Sent regarding this Grant</a>
    <br/><br/>
    <a href="DiAdminComments.do?todo=add">Add a new Comment</a>
  </p>
