...
<html>
  ...
  <table align="center" width="95%" summary="for layout only" >  
    <tr>
      <th colspan="7" bgcolor="Silver">Personal Service Expenses</th>
    </tr>
    <tr>
      <td colspan="7">            
        ...
        <logic:iterate name="budgetBean" property="allPersRecords" id="PersonalBean" > 
          ...
          <tr>
            ...
            <td><fmt:formatNumber value="${PersonalBean.salary}" type="currency" maxFractionDigits="0" /></td>
  ...
  <tr>
    <th colspan="7" bgcolor="Silver">Employee Benefit Expenses</th>
  </tr>
  <tr>
    <td colspan="7">
    ...
    <tr>
     <th colspan="7" bgcolor="Silver">Contracted Services Expenses</th>
    </tr>
    <tr>
      <td colspan="7">                
    ...
    <tr>
     <th colspan="7" bgcolor="Silver">Supplies, Materials and Equipment Expenses</th>
    </tr>
    <tr>
      <td colspan="7">      
        ...
        <logic:iterate name="budgetBean" property="allSupplyRecords" id="SupplyBean" > 
          <table width="100%">
          <tr>
            <td><b>Quantity</b></td><td colspan="2"><b>Description</b></td>
            <td><b>Unit Price</b></td><td colspan="2"><b>Vendor</b></td>
          </tr>
          <tr>
            <td><c:out value="${SupplyBean.quantity}" /></td>
            <td colspan="2"><c:out value="${SupplyBean.description}" /></td>
            <td><fmt:formatNumber value="${SupplyBean.unitprice}" type="currency" /></td>
            <td colspan="2"><c:out value="${SupplyBean.vendor}" /></td>
          </tr>
          <tr>
            <td colspan="2"><b>Purchase Order Date</b></td>    
            <td colspan="2"><b>Check/Journal Entry#</b></td>
    ...
    <tr>
     <th colspan="7" bgcolor="Silver">Travel Expenses</th>
    </tr>
    <tr>
      <td colspan="7">               
