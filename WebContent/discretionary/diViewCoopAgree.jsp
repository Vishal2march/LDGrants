 ...
 * Name of the Application        :  diViewCoopAgree.jsp
 * Creation/Modification History  :
 *
 *     SHusak       2/21/08     Created
 *
 * Description
 * This page used for DI participants to view/print coopagreement form and link
 * to jsp page to add the form as an attachment. 
--%>
...
<html>
  ...
  <p><b>Instructions</b><br/>
    ...
    Please put "Co Agreement" as the description for your uploaded attachment.  
    <br/>View <a href="ApcntFunctionsServlet?i=coopagree" target="_blank">PDF</a> version of Cooperative Agreement Form
    <br/><a href="DiPartAddDocument.do"> Upload</a> your Cooperative Agreement Form to this grant application.
  </p>
