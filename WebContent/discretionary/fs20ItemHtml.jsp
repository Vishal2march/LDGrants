...
<html>
  ...
  <table align="center" width="95%" summary="for layout only">
    <tr>
      ...
      <td valign="top"><b>PROPOSED BUDGET SUMMARY FOR A
  ...
  <table align="center" width="96%" style="outline-style:solid; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only" >
    ...
    <tr >
      <td>
        <p align="left">Submit the original FS-20 Budget Summary with signature in blue ink and the required number of copies 
        ...
        <p align="left">Enter whole dollar amounts only.  The amounts must agree with the budget 
        category totals from each Budget Category and Narrative Form.</p>
      ...
      <td valign="top">
        <table width="100%" style="outline-style:solid; outline-width:1.0px; outline-color:rgb(0,0,0); border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
         <tr>
          ...
          <tr>
            <th>Agency Name</th><td><c:out value="${thisGrant.instName}" /></td>
          </tr>
          <tr>
            <td height="15"></td>
          </tr>
