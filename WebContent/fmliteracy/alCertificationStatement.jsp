 ...
 * Name of the Application        :  alCertificationStatement.jsp
...
<html>
  <head>
    ...
    <title>alCertificationStatement</title>
  </head>
  <body>
  ...
  <table width="90%" align="center" class="boxtype" summary="for layout only">
    <tr>
      <th colspan="2" align="center">Adult Literacy Library Services</th>
    </tr>
    <tr>
    ...
    <form action="liSubmitCertApp.do?i=verifyinitiallit" method="POST">
        <tr>
          ...
          <input type="CHECKBOX" name="directorcert" value="Y">
        ...
        <c:choose >
        <c:when test="${lduser.prgal!='submit'}">
