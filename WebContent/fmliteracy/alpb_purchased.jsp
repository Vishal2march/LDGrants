...
<html>
  ...
  rentals, tuition, printing, communications, and other contractual services).  Group budget 
  records by vendor.  Attach per 
  ...
  <a name="year1" />
  <html:errors />
  <html:form action="/saveAlContract" >
    ...
    <c:otherwise >
      <tr>
        <td align="center">
          ...
          <html:hidden property="module" value="alb"/><input type="hidden" name="litpge" value='4'/>
        </td>  
      </tr>            
    </c:otherwise>
    </c:choose>
