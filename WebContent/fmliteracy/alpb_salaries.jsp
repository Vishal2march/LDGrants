...
<html>
  ...
  <a name="year1" />
  <html:errors />
  <html:form action="/saveAlPersonal">
  <table width="95%" align="center" summary="for layout only" >
    <tr>
      <td><b>Budget Year 1 (<c:out value="${thisGrant.fiscalyear}" />) </b>
        ...
        <%--SH 9/27/12 no longer using salaries category for FY13-14
      ...
      <td>   
        ...
        <table width="100%" summary="for layout only" class="boxtype">
          ...
          <c:url value="liInitialForms.do" var="deleteURL">
            ...
            <c:param name="p" value="al${littab}" />
        </c:url>
          ...
          <tr>
            ...
            <html:hidden name="personalItem" property="module" indexed="true" value="al" />
    ...
    <c:otherwise >
      <tr>
        <td align="center">
          ...
          <html:hidden property="module" value="alb"/><input type="hidden" name="litpge" value='<c:out value="${littab}"/>'/>
        </td>  
      </tr>            
    </c:otherwise>
    </c:choose>
