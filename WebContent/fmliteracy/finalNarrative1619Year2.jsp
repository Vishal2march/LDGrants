...
<html>
  <head>
    ...
    <title>finalNarrative1619Year2</title>
  ...
  <table width="90%" summary="for layout only"><%--2 column page layout --%>
    <tr>
      <td width="30%" valign="top">
          ...
          <c:choose>
          <c:when test="${param.p=='fl'}" ><%--family lit menu year 2 --%>
          
            <div style="border-style:solid; border-width:thin; padding:5.0px;">
              <b>Narrative Menu</b>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=123">Goals/Objectives/Activities</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=126">Summary of Evaluation Outcomes/Outputs</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=64">Budget Changes</a>
              <br/><br/>
            </div>
            
          </c:when>
          <c:when test="${param.p=='al'}"><%--adult lit menu year 2 --%>
          
            <div style="border-style:solid; border-width:thin;">
              <b>Narrative Menu</b>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=123">Goals/Objectives/Activities</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=126">Summary of Evaluation Outcomes/Outputs</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=64">Budget Changes</a>
              <br/><br/>
            </div>
