...
<html>
  <head>
    ...
    <title>finalNarrative1619Year3</title>
      ...
      <td width="30%" valign="top">
          ...
          <c:when test="${param.p=='fl'}" ><%--family lit menu year 1 --%>
            ...
            <div style="border-style:solid; border-width:thin; padding:5.0px;">
              <b>Narrative Menu</b>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=124">Goals/Objectives/Activities</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=127">Summary of Evaluation Outcomes/Outputs</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=105">Budget Changes</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=frpt&id=118">3 Year Summary</a>
              <br/><br/>
          ...
          <c:when test="${param.p=='al'}"><%--adult lit menu year 1 --%>
            ...
            <div style="border-style:solid; border-width:thin;">
              <b>Narrative Menu</b>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=124">Goals/Objectives/Activities</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=127">Summary of Evaluation Outcomes/Outputs</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=105">Budget Changes</a>
              <br/><br/>
              <a class="discnarr" href="liNarrative.do?t=afrpt&id=118">3 Year Summary</a>
              <br/><br/>
