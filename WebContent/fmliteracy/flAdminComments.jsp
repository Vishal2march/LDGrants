...
<html>
  ...
  <c:when test="${param.todo!='view' }">
    ...
    <c:if test="${param.todo=='delete'}">
      ...
      <form method="POST" action="adminCommentNav.do?item=deletec" >
        ...
        <input name="p" type="HIDDEN" value="fl"/>
  ...
  <p >
    <a href="FlAdminComments.do?todo=add">Add a new Comment</a>
  </p>
  ...
  <table align="center" width="100%" class="boxtype" summary="for layout only">    
    ...
    <c:forEach var="commBean" items="${allComments}" >
      <c:url value="FlAdminComments.do" var="deleteURL">
    ...
    <tr>
      <td colspan="5" align="center"><input name="p" type="HIDDEN" value="fl"/>
