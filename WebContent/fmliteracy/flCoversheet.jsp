...
<html>
  ...
  <h4>Cover Page</h4> 
    ...
    <table width="90%" align="center" border="1" class="graygrid" summary="for layout only">
      ...
      <c:when test="${thisGrant.fycode==14}">
          <%--for projects in 2013-14 (3 year grants) --%>
    ...
    <c:choose >
    <c:when test="${lduser.prgfl=='read' || appStatus.coversheetyn=='true' || appStatus.pendingReview=='true' }">
                           
  
    <table border="1" width="90%" class="graygrid" align="center" summary="for layout only">
      <tr>
        <th colspan="2" bgcolor="Silver">Project Manager (is someone who has expertise in the area of this program (youth/early literacy/etc.))</th>
      </tr>          
      <tr>
        <td width="30%">Name</td>
  ...
  <p><html:errors /></p>
  <html:form action="/flSaveCoverpage" >    
    ...
    <p align="center">
      <html:hidden property="grantid" /><html:hidden property="module" value="fl" />
  ...
  <%--1/14/16 per KBALSEN
  <p align="center" >
    Select <a href="liInitialForms.do?item=partinst&p=fl">Participating Institutions</a> for this
    proposal. 
  </p> 
  --%>
