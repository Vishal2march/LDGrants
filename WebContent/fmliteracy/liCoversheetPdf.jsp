...
<html>
  ...
  <font size="1">
  <p align="center"><c:if test="${thisGrant.fccode==40}" >Adult</c:if>
    ...
    <font size="1">
    <table width="100%" align="center" border="1" summary="for layout only">
      <tr>
    ...
    <table border="1" width="100%" align="center" summary="for layout only">
      <tr>
