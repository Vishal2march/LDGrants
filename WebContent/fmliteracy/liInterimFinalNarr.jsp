...
<html>
  ...
  <br/><br/>
   ...
   <c:if test="${thisGrant.fccode==40 || thisGrant.fycode<14}">
    ...
    <tr>
      <th bgcolor="Silver">Sharing Results/Publicity (Year 1)</th>
    </tr>
    <tr>
    ...
    <tr>
      <th bgcolor="Silver">Sharing Results/Publicity (Year 2)</th>
    </tr>
    <tr>
    ...
    <c:if test="${thisGrant.fycode>13}">
        ...
        <tr>
          <th bgcolor="Silver">Sharing Results/Publicity (Year 3)</th>
        </tr>
        <tr>
