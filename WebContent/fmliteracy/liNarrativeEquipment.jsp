 ...
 * Name of the Application        :  liNarrativeEquipment.jsp
 * Creation/Modification History  :    
 *     SHusak  1/25/16 Created
 *
 * Description
 * This will be new budget summary/narrative for equipment, for both AL/FL, starting for 2016-19.
 * Per KBALSEN, the applicant fills out this equipment budget summary at initial application (instead of
...
<html>
  <head>
    ...
    <title>liNarrativeEquipment</title>
  </head>
  <body>
  
  <br/><br/>
  <p align="left"><b>Equipment Budget Summary</b> (include each year separately. If multiple items are known for each year, add repeating groups so everything can be listed.)</p>
    ...
    <html:form action="/saveLitSummaryBudget" >
        ...
        <logic:iterate name="BudgetCollectionBean" property="allSummaryRecords" id="summaryRecordItem" >   
          ...
          <c:url value="budgetSummaryNav.do" var="deleteURL">
            ...
            <c:param name="c" value="20" />
            <c:param name="narr" value="121" />
          </c:url>          
        ...
        <tr>
          <td colspan="5" align="center">
              ...
              <input type="hidden" name="narr" value="121"/>
