 ...
 * Name of the Application        :  liNarrativePurchased.jsp
 * Creation/Modification History  :    
 *     SHusak  1/21/16 Created
 *
 * Description
 * This will be new budget summary/narrative for purchased services, for both AL/FL, starting for 2016-19.
 * Per KBALSEN, the applicant fills out this purchased services budget summary at initial application (instead of
...
<html>
  <head>
    ...
    <title>liNarrativePurchased</title>
  </head>
  <body>
  
  <br/><br/>
  <p align="left"><b>Purchased Services Budget Summary</b> (include each year separately. If multiple items are known for each year, add repeating groups so everything can be listed.)</p>
  ...
  <table width="100%" class="boxtype">
    <tr>
      <th>Year</th><th>Anticipated Amount</th><th>Service Type</th><th>Consultant/Vendor or various</th><th>Delete</th>
    </tr>
    ...
    <html:form action="/saveLitSummaryBudget" >
        ...
        <logic:iterate name="BudgetCollectionBean" property="allSummaryRecords" id="summaryRecordItem" >   
          ...
          <c:url value="budgetSummaryNav.do" var="deleteURL">
            ...
            <c:param name="c" value="40" />
            <c:param name="narr" value="38" />
          </c:url>          
          ...
          <tr>      
            ...
            <td width="20%"><html:text name="summaryRecordItem" property="amountStr" indexed="true" /></td>
            <td width="20%"><html:text name="summaryRecordItem" property="serviceType" indexed="true" /></td>
             <td width="20%"><html:text name="summaryRecordItem" property="vendor" indexed="true" />
        ...
        <tr>
          <td colspan="5" align="center">
              ...
              <input type="hidden" name="narr" value="38"/>
