 ...
 * Name of the Application        :  liNarrativeSupply.jsp
 * Creation/Modification History  :    
 *     SHusak  1/25/16 Created
 *
 * Description
 * This will be new budget summary/narrative for supplies, for both AL/FL, starting for 2016-19.
 * Per KBALSEN, the applicant fills out this supply/material budget summary at initial application (instead of
...
<html>
  <head>
    ...
    <title>liNarrativeSupply</title>
  </head>
  <body>
  
  <br/><br/>
  <p align="left"><b>Supply/Material Budget Summary</b> (include each year separately. If multiple items are known for each year, add repeating groups so everything can be listed.)</p>
  ...
  <table width="100%" class="boxtype">
    <tr>
      <th>Year</th><th>Anticipated Amount</th><th>Item Description</th><th>Vendor or various</th><th>Delete</th>
    </tr>
    ...
    <html:form action="/saveLitSummaryBudget" >
        ...
        <logic:iterate name="BudgetCollectionBean" property="allSummaryRecords" id="summaryRecordItem" >   
          ...
          <c:url value="budgetSummaryNav.do" var="deleteURL">
            ...
            <c:param name="c" value="45" />
            <c:param name="narr" value="39" />
          </c:url>          
          ...
          <tr>      
            ...
            <td width="20%"><html:text name="summaryRecordItem" property="description" indexed="true" /></td>
        ...
        <tr>
          <td colspan="5" align="center">
              ...
              <input type="hidden" name="narr" value="39"/>
