...
<html>
  ...
  <table align="center" class="fsLarge" summary="for layout only" >
    ...
    <tr>
      <td>
       <p>This form has been customized for use for the State Construction Program
       ONLY and therefore should not be used for any other purpose. </p>
       <p>Submit three sets of the FS-10-F form with original signatures in blue ink to
       Kim Anderson, Division of Library Development, Room 10B41 Cultural Education 
       Center, Albany, NY  12230.</p>       
       <p>All budget items for this program should be entered in whole dollar amounts only.</p>
       
       <p>Certification on last page must be signed in blue ink by Chief Administrative Officer or designee.</p>
       <p>High quality computer generated reproductions of this form may be used.</p>
       <p>For further information on completing the final expenditure report,  
       refer to the Fiscal Guidelines for Federal and State Aided Grants which 
       may be accessed at www.oms.nysed.gov/cafe/ or 
       contact Kimberly Anderson at kimberly.anderson@nysed.gov or 518-486-5252</p>
      </td>
    </tr>
  </table>
...
<br/><div class="pageBreak" />
  ...
  <table width="96%" border="1" class="fsLarge" summary="for layout only">
    ...
    <h3 align="center">INDIRECT COST: Code 90</h3>
  ...
  <p>Beginning with the 2005-06 year, all equipment to be purchased in support of 
...
<table width="95%" align="center" summary="for layout only">
    <tr>
      <td colspan="2"><h3>FINAL EXPENDITURE</h3></td>
    </tr>
    
    <tr>
      <td width="50%" valign="top">
        <table width="100%" border="1" style="outline-style:solid; outline-width:1.0px; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
          <tr>
      ...
      <td valign="top" width="50%">
        <table width="100%" style="outline-style:solid; outline-width:1.0px; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
          ...
          <tr>
            ...
            <td align="center"><hr/>Final Payment</td>
          </tr>
          <tr>
          <tr>
            <td>Finance:</td>
