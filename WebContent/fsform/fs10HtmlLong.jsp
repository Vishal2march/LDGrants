...
<html>
 ...
 <c:otherwise>
  ...
  <h3 align="center">SALARIES FOR PROFESSIONAL STAFF:  Code 15 
  ...
  <table width="96%" border="1" summary="for layout only">
    ...
    <logic:iterate name="budgetBean" property="allPersRecords" id="PersonalBean" > 
      ...
      <c:set var="pertot" value="${pertot + PersonalBean.grantrequest}"/>
      </c:if>
    </logic:iterate>
    </logic:present>
    <tr>
  ...
  <h3 align="center">SALARIES FOR SUPPORT STAFF:  Code 16
  <c:if test="${thisGrant.fccode==42 || thisGrant.fccode==40}">Do Not Use For Literacy Program</c:if>
  </h3>
...
<br/><div class="pageBreak" />  
  ...
  <table width="96%" border="1" summary="for layout only">
    ...
    <c:set var="contot" value="${contot + ContractedBean.grantrequest}"/>
    </c:if>
    ...
    <tr>
      ...
      <td><fmt:formatNumber value="${contot}" type="currency"/></td>
    </tr>
  ...
  <table width="96%" border="1" summary="for layout only">
    ...
    <logic:iterate name="budgetBean" property="allSupplyRecords" id="SupplyBean" > 
        ...
        <c:set var="supptot" value="${supptot + SupplyBean.grantrequest}"/>
      </c:if>
    </logic:iterate>
    </logic:present>
    <tr>
  ...
  <table width="96%" border="1" summary="for layout only">
    ...
    <tr>
      ...
      <td><fmt:formatNumber value="${totalsBean.travAmtReq}" type="currency"/></td>
    </tr>
    
  </table>
  
  
  <h3 align="center">EMPLOYEE BENEFITS:  Code 80
  <c:if test="${thisGrant.fccode==42 || thisGrant.fccode==40}">Do Not Use For Literacy Program</c:if>
 </h3>
  ...
  <table width="96%" border="1" summary="for layout only">
    <tr>
      ...
      <th width="50%">Proposed Expenditure</th>
    </tr>
    <tr>
      <td height="50">Social Security</td>
      <td height="50">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="50">Health Insurance</td>
      <td height="50">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <logic:iterate name="budgetBean" property="allBenRecords" id="BenefitsBean" > 
          <fmt:formatNumber value="${BenefitsBean.grantrequest}" type="currency" maxFractionDigits="0" /><br/>
        </logic:iterate>
        </logic:present>
      </td>
    </tr>
  ...
  <table width="96%" border="1" summary="for layout only">
    <tr>
      <th width="20%">Description of Services</th>
    ...
    <logic:iterate name="budgetBean" property="allContractRecords" id="ContractedBean" > 
      ...
      <c:if test="${ContractedBean.typeCode==6}">
      <tr>
      <td><c:out value="${ContractedBean.servicedescr}" /></td>
      <td><c:out value="${ContractedBean.recipient}" /></td>
      <td><c:out value="${ContractedBean.servicetype}" /></td>
  ...
  <table width="96%" border="1" summary="for layout only">
    <tr>
      <th width="30%">Description of Work To Be Performed</th>
      <th width="30%">Calculation of  Cost</th>
      <th width="30%">Proposed Expenditures</th>
    </tr>
    ...
    <logic:iterate name="budgetBean" property="allExpRecords" id="OtherExpBean" > 
      <tr>
        ...
        <td><c:out value="${OtherExpBean.costsummary}" /></td>
        <td><fmt:formatNumber value="${OtherExpBean.grantrequest}" type="currency" maxFractionDigits="0" /></td>
      </tr>
    </logic:iterate>
    </logic:present>
    <tr>
      <td colspan="2" align="right">Subtotal - Code 30</td>
      <td><fmt:formatNumber value="${totalsBean.othAmtReq}" type="currency"/></td>
    </tr>
  </table>
  ...
  <table width="96%" border="1" summary="for layout only">
    ...
    <logic:iterate name="budgetBean" property="allSupplyRecords" id="SupplyBean" > 
        ...
        <c:set var="equiptot" value="${equiptot + SupplyBean.grantrequest}" />
        </c:if>
    </logic:iterate>
    </logic:present>
    <tr>
...
<h3 align="center">Helpful Reminders</h3>  
  ...
  <p>Be sure to complete the Agency Code and Project # on Page 8 as well as the Project #, if pre-assigned.
  For Special 
  Legislative projects and Grant Contracts, also enter the Contract #.</p>
  
  <p>For ease of data entry at the State Education Department, please make sure
...
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
  ...
  <table width="96%" align="center" summary="for layout only">
    ...
    <tr><!-- top row contains top 2 boxes - categories and agency code -->
      ...
      <c:choose>
      <c:when test="${thisGrant.fccode==42 || thisGrant.fccode==40}">
        <%-- for adult/family lit, print blank amts (per LAREFORD)
            modified on 9/11/15 per BMASSAGO to print total amt_requested  --%>
       <table width="100%" style="outline-style:solid; outline-width:1.0px; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
          ...
          <TR>
            ...
            <td><fmt:formatNumber value="${totalsBean.totAmtReq}" type="currency"/></td>
          </TR>
        </table>          
      </c:when>
      <c:otherwise>
        <table width="100%" style="outline-style:solid; outline-width:1.0px; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
          ...
          <TR>
            ...
            <fmt:formatNumber value="${totalsBean.totAmtReq}" type="currency"/></td>
          </TR>
        </table>    
        </c:otherwise>
        </c:choose>
