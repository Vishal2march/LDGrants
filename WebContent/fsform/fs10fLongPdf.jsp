...
<html>
 ...
 <c:when test="${thisGrant.fccode==6 ||  thisGrant.fccode==7 || thisGrant.fccode==5 || thisGrant.fccode==42 || thisGrant.fccode==40 || thisGrant.fccode==20}">
  ...
  <table align="center" width="96%" style="outline-style:solid; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only" >
    <tr>
      <td><b>INSTRUCTIONS</b><br/>
       Agencies must maintain complete and accurate records and may be requested to provide additional detail to 
       ...
       program for which you are applying. DO NOT submit this form to the Grants Finance.<br/><br/>
       
       All encumbrances must have taken place within the approved funding dates of the project. <br/>
       
       Use whole dollar amounts. <br/>
       
       Certification on page 8 must be signed by Chief Administrative Officer or designee. <br/><br/>
       High quality computer generated reproductions of this form may be used.<br/><br/>
       For further information on completing the final expenditure report, please 
       refer to the Fiscal Guidelines for Federal and State Aided Grants 
       at www.oms.nysed.gov/cafe/ or contact Grants Finance at grantsweb@nysed.gov or (518) 474-4815.
      </td>
    </tr>
  </table>
  </font>
  ...
  Items of equipment purchased must agree in type and number with the equipment
  ...
  Be sure to submit one original and 2 copies directly to the appropriate State 
   Education Department office as indicated in the application instructions for the grant 
   program for which you are applying. DO NOT submit this form to the Grants Finance.<br/><br/>
  
  For State projects, final expenditure reports are due within 30 days after the project end date.  
...
Award Notice to verify the due date.  <br/><br/>
  
  After review by Grants Finance, a copy of the FS-10-F will be sent to the contact person at the 
address on Page 1. <br/><br/>

  All encumbrances must be made within the approved project funding dates, 
  ...
  explanation of the review process.<br/><br/>
  
  Be sure to check your math and carry all subtotals forward to the Summary 
  ...
  Use whole dollars only.<br/><br/>
    
  Be sure to complete the Agency Code and Project # on Page 8.  For Special 
  Legislative projects and Grant Contracts, also enter the Contract #.<br/><br/>
  
  Please make sure  that Page 8 faces out.</p>
  </font>
