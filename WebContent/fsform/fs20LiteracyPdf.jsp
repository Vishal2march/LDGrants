...
<html>
  ...
  <table align="center" width="95%" summary="for layout only">
    <tr>
      ...
      <td valign="top">PROPOSED BUDGET SUMMARY FOR A FEDERAL OR STATE PROJECT
          <br/>FS-20 (12/05) 
          <br/><br/>
    ...
    <tr><!-- top row contains top 2 boxes - categories and agency code -->
      <td valign="top" width="40%" rowspan="2">
        ...
        <table style="outline-style:solid; outline-width:1.0px; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
          ...
          <TR>
            <Td>Professional Salaries</Td><td align="center">15</td><td>xxxx</td>
          </TR>
          <TR>
            <Td>Support Staff Salaries</Td><td align="center">16</td><td>xxxx</td>
          </TR>
          <TR>
          ...
          <TR>
            <Td>Employee Benefits</Td><td align="center">80</td><td>xxxx</td>
          </TR>
          <tr>
            <td>BOCES Services</td><td align="center">49</td><td>xxxx</td>
          </tr>
          <TR>
            <Td>Minor Remodeling</Td><td align="center">30</td><td>xxxx</td>
          </TR>
          <TR>
