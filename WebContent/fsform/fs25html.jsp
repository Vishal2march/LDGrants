...
<html>
  ...
  <table width="96%" align="center" class="fsLarge" summary="for layout only">
    <tr>
  ...
  <table width="96%" align="center" class="fsLarge" summary="for layout only">
    <tr>
      <td height="30">1. Amount of Approved Budget (Include approved amendments)</td>
      <td>$______________</td>
    </tr>
    <tr>
      <td height="30">2. Project Payments Received to Date</td>
      <td>$______________</td>
    </tr>
    <tr>
      <td height="30">3. Project Cash Expenditures to Date</td>
      <td>$______________</td>
    </tr>
    <tr>
      <td height="30">4. Cash Expenditures Anticipated During Next Month</td>
      <td>$______________</td>
    </tr>
    <tr>
      <td height="30">5. Additional Funds Requested (Entries 3 plus 4 minus 2)</td>
      <td>$______________</td>
    </tr>      
  </table>
  <br/>
