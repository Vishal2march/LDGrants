...
<html>
  <head>
    ...
    <title>LGRMIF Deliberation Form 2012-13</title>
  ...
  <table align="center" width="95%" summary="for layout only" class="boxtype">
    <tr>
        <th colspan="2">LGRMIF Grant Final Deliberation Form 2012-2013</th>
    </tr>
    <tr>
  ...
  <table width="95%" summary="for layout only">
    ...
    <tr>
      ...
      <td><c:out value="${RatingBean.otherfundDelibStr}" /></td>
    </tr>
    <tr>
      <td height="10" />
    </tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td><c:out value="${RatingBean.improveservDelibStr}" /></td>
    </tr>
    <tr>
      <td height="10" />
    </tr>
    ...
    <tr>
      ...
      requirements of the specific project category and type  [10 points] </td>
