...
<html>
      ...
      <td colspan="6">            
        ...
        <logic:iterate name="budgetBean" property="allPersRecords" id="PersonalBean" > 
          ...
          <tr>
            ...
            <td><b>Rate of Pay</b></td><td><b>Hours Worked</b></td><td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="17%"><b>ExpSubmitted</b></td><td width="17%"><b>ExpApproved</b></td>
          </tr>  
          <tr>
  ...
  <logic:notEmpty name="budgetBean" property="allPersRecords">
    ...
    <tr>
      <td width="17%">Inst Contrib.</td>
      <td width="17%">AmtRequested</td>
      <td width="17%">AmtAwarded</td>
      <td width="17%">AmtAmended</td>
      <td width="17%">ExpSubmitted</td>
      <td width="17%">ExpApproved</td>
    </tr>
    <tr>
      <td>0</td>
