  ...
  <table align="center" width="90%" border="1" class="graygrid" summary="for layout only">
    ...
    <tr>
      <td colspan="2"><b>NOTE:</b>The institutional information listed above
        ...
        by Grants Finance.  Grant Unit staff do not have authority to update SEDREF information.<br/>
        The applicant cannot edit the SEDREF information above on their own.</td>
    </tr>
    <tr>
