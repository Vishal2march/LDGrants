...
<html>
  <head>
    ...
    <title>Awards By Government Type</title>
  ...
  <table width="100%">
    <tr>
      <th>LGRMIF awards report by government type for fiscal year <c:out value="${fybean.year}" /></th>
    </tr>
  </table>
  <br/>
  ...
  <display:table name="sessionScope.allGrants"  requestURI="" id="row" decorator="org.displaytag.decorator.TotalTableDecorator" export="true">
    <display:column property="title" title="Government Type" sortable="true" headerClass="sortable" />
