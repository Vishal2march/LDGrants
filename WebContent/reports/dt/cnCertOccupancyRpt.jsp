...
<html>
  ...
  <table width="100%">
    ...
    <tr>
      <th>Public Library Construction Grant Program: Submitted applications that will
      require a local Certificate of Occupancy</th>
    </tr>
  </table>
  <br/><br/>
  ...
  <display:table name="sessionScope.allApplications" id="row" requestURI="" export="true" decorator="org.displaytag.decorator.TotalTableDecorator">
    ...
    <display:column property="cooperative" title="Certificate of Occupancy" />
