...
<html>
  <head>
    ...
    <title>Public Library Construction - Final Expenses Submitted Report</title>
  ...
  <table width="100%">
    ...
    <tr>
      <th>Public Library Construction Grant Program: Final Expenses Submitted list</th>
    </tr>
  </table>
  <br/><br/>
  ...
  <display:table name="sessionScope.allApplications" id="row" requestURI="" export="true" decorator="org.displaytag.decorator.TotalTableDecorator">
    ...
    <display:column property="dateSubmitStr" title="Date Library Submitted Final Rpt" sortable="true"/>
    
    <display:column property="totalRecommend" format="$ {0,number,0,000}" title="Award Amount" total="true" sortable="true"/>
    <display:column property="totalRequest" format="$ {0,number,0,000}" title="Expenses" total="true" sortable="true"/>
    <display:column property="finalApprove" title="Is Final Approved" sortable="true"/>
