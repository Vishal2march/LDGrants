...
<html>
  ...
  <display:table name="sessionScope.allApplications" id="row" requestURI="" export="true" decorator="org.displaytag.decorator.TotalTableDecorator">
    ...
    <display:column property="totalApproved" format="$ {0,number,0,000}" title="LD Award" total="true" sortable="true"/>
    <display:column property="approvedPercentStr" title="Award % of Proj Cost" sortable="true" headerClass="sortable" />
