...
<html>
  ...
  <table width="100%">
    ...
    <tr>
      <th>Public Library Construction Grant Program: Submitted applications with Total Project Cost (from 
      Part A of Application Form)</th>
    </tr>
  </table>
  <br/><br/>
  ...
  <display:table name="sessionScope.allApplications" id="row" requestURI="" export="true" decorator="org.displaytag.decorator.TotalTableDecorator">
    ...
    <display:column property="totalRequest" format="$ {0,number,0,000}" title="Total Project Cost" total="true" />
