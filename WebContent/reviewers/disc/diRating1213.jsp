...
<html>
  ...
  <table align="center" width="95%" summary="for layout only" class="boxtype">
    ...
    <tr>
      ...
      <td><font color="Navy"><b><fmt:formatNumber value="${RatingBean.overallscore +commitval +accessval +budgval*2.23 +rval*3 +pval*3}" maxFractionDigits="2" /></b></font></td>
    </tr>
    <tr>
      <td height="30" />
    </tr>
    ...
    <html:form action="/saveDiNewRating">
    <tr>
      <th colspan="2">Institutional Commitment to Conservation/Preservation Work</th>
    ...
    <tr>
      <td><font color="Navy"><b>Grand Total</b>   (max 86 pts)</font></td>
      <td><font color="Navy"><b>
      <fmt:formatNumber value="${RatingBean.overallscore +commitval +accessval +budgval*2.23 + resval*3 + planval*3}" maxFractionDigits="2" /></b></font></td>
    </tr>
    <tr>
      <td height="30" />
    </tr>
    ...
    <tr>
      <td colspan="2" align="center">
        <html:textarea property="comment" rows="10" cols="80"/></td>
    </tr>
    <tr>
