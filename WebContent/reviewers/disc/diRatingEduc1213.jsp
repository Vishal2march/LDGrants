...
<html>
  ...
  <table align="center" width="95%" summary="for layout only" class="boxtype">
    ...
    <tr>
      ...
      <td><font color="Navy"><b><fmt:formatNumber value="${RatingBean.overallscore +edval*3.25 +budgval*2.23 +pval*3}" maxFractionDigits="2" /></b></font></td>
    </tr>
    <tr>
      <td height="30" />
    </tr>
    ...
    <html:form action="/saveNewEducRating">
    <tr>
    ...
    <tr>
      ...
      <fmt:formatNumber value="${RatingBean.overallscore +edval*3.25 +budgval*2.23  +planval*3}" maxFractionDigits="2" /></b></font></td>
    </tr>
    <tr>
      <td height="30" />
    </tr>
