...
<html>
  <head>
    ...
    <title>deliberationForm1516</title>
  ...
  <body>
   ...
   <h5>LGRMIF Final Evaluation Form (Deliberation) beginning FY 2015-16</h5>
  ...
  <html:form action="/saveDelibRating1516">  
  <table width="95%" summary="for layout only">
    ...
    <tr>
      <th colspan="2">2. Intended Results (20 Points)</th>
    </tr>
    <tr>
  ...
  <html:form action="/saveDeliberation1516">
  <table width="85%" summary="for layout only">      
    ...
    <tr>      
      ...
      <td></td>
      <td><html:text property="bonusScore"/>
    <tr>
    <tr>
      <td>Total Score + Bonus Scoring</td>
      <td></td>
      <td><c:out value="${PanelReviewBean.bonusScore + PanelReviewBean.finalscore}"/>
    <tr>
    <tr>
        <td height="20%"></td>
    </tr>
  ...
  <hr style="border-width:thick; border-color:rgb(0,0,0);"/>
    ...
    <br/><br/><br/>
    <html:form action="saveDelibNarr1516">
    <table width="85%" summary="for layout only">
        <tr>
  ...
  <!--THIS SECTION IS WHEN THE PANEL STATUS = PARTIAL OR  STATUS = NONE-->
    ...
    <table width="85%" summary="for layout only">      
        ...
        <tr>      
          <td>Bonus Scoring (for funding priority)</td>
          <td></td>
          <td><c:out value="${PanelReviewBean.bonusScore}"/>
        <tr>
        <tr>
          <td>Total Score + Bonus Scoring</td>
          <td></td>
