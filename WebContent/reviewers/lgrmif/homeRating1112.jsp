...
<html>
  <head>
    ...
    <title>At Home Reviewer Rating Form</title>
  ...
  <h5>NEW LGRMIF Grant Evaluation Form</h5>
 ...
 <%-- RATING FORM READ ONLY (AFTER SUBMIT or after the due date)   --%>
    ...
    <tr>
      ...
      (15 points) (Assign a score of 0-5, as the system will calculate the total value in the Total At-Home Score )</td>
    ...
    <tr>
      ...
      of the specific project category and type 
      [10 points] (Assign a score of 0-5, as the system will calculate the total value in the Total At-Home Score )</td>
    ...
    <tr>
      ...
      activities. [25 points] (Assign a score of 0-5, as the system will calculate the total value in the Total At-Home Score )</td>
  ...
  <html:form action="/saveLgNewRating">  
  <table align="center" width="95%" summary="for layout only">
    <tr>
      <th colspan="2">Criteria</th>
    </tr>
    ...
    <tr>
     ...
     <tr>
      <td>c. Describes in detail how the project will improve local government services
      to the public [5 points]</td>
      <td><html:text property="improveservStr" /></td>
    </tr>
    <tr>
      <td height="10" />
    </tr>
    ...
    <tr>
      <td>a. Justifies all project expenditures, and demonstrates that the proposed 
      expenditures are reasonable. [25 points] (Assign a score of 0-5, as the system will 
      calculate the total value in the Total At-Home Score )</td>
