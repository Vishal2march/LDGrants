 ...
 * Name of the Application        :  fs10aHTML.jsp
...
<html>
  <head>
    ...
    <link href="css/FsFormStyle.css" rel="stylesheet" media="print" type="text/css" />
  </head>
  <body>
  ...
  <c:otherwise>
   ...
   <table align="center" width="95%" summary="for layout only">
    <tr>
      <td valign="top"><b>The University of the State of New York		
          <br/>THE STATE EDUCATION DEPARTMENT			
          <br/>(see instructions for mailing address)</b>
      </td>
      <td valign="top"><b>PROPOSED AMENDMENT FOR A<br/>FEDERAL OR STATE PROJECT
          <br/>FS-10-A (03/15)</b>
      </td>
    </tr>
  </table>
  ...
  <table width="95%" align="center" style="outline-style:solid; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
  <tr>
    <td colspan="2">Fund Source: <b><c:out value="${fundsource}"/></b><br/>
  ...
  <tr>
    ...
    <td width="40%">Amendment #: _____________________</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <ul>
        <li>Submit three copies with signatures in blue ink directly to the same State Education Department 
        office where budget was mailed.  DO NOT submit this form to the Grants Finance Unit.</li>
        <li>Enter whole dollar amounts only.</li>
        <li>This form need only be submitted for budget changes that require prior approval as follows:
        <ul>
          <li>Personnel positions, number and type</li>
          <li>Equipment items having a unit value of $5,000 or more, number and type</li>
          <li>Minor remodeling</li>
          <li>Any increase in a budget subtotal (professional salaries, purchased services, travel, etc.) by more than 10 percent or $1,000, whichever is greater</li>
          <li>Any increase in the total budget amount.</li>
        </ul>
        </li>
        <li>Amendment # at top of this page must be completed.</li>
        <li>Do not use the FS-10-A for requesting a project extension.</li>
      </ul>
    </td>
  </tr>  
  </table>
  ...
  <tr>
    <td>
      <table width="100%" summary="for layout only" style="outline-style:solid; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;">
        <tr>
  ...
  <table width="95%" align="center" border="1" style="outline-style:solid; border-color:rgb(0,0,0); border-style:solid; border-width:1.0px;" summary="for layout only">
    <tr>
      <th>SUBTOTAL</th>
