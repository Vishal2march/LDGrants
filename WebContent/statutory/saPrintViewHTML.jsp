 ...
 * Name of the Application        :  saPrintViewHTML.jsp
 * Creation/Modification History  :
 *
 *     SHusak   3/1/07 Created   2/15/08 Modified to show authorizations
 *
 * Description
 * This page allows the applicant to view a HTML version of the
 * complete grant application info that was entered by the applicant.
--%>
...
<html>
  ...
  <table align="center" width="95%" summary="for layout only">
    ...
    <tr>
      <th bgcolor="Silver">
        Summary Description of proposed preservation activities
      </th>
    </tr>
    <tr>
  ...
  <tr bgcolor="Silver">
   ...
   <logic:notEmpty name="budgetBean" property="allTravelRecords">    
    ...
    <c:if test="${not empty allFSRecords}" >
        ...
        <tr>
          <td width="20%"><c:out value="${FS10Bean.expname}" /></td>
          <td width="20%" ><c:out value="${FS10Bean.description}" /></td>
          <td width="20%"><fmt:formatNumber value="${FS10Bean.amountincr}" type="currency" maxFractionDigits="0" /></td>
          <td width="20%"><fmt:formatNumber value="${FS10Bean.amountdecr}" type="currency" maxFractionDigits="0" /></td>
        </tr>
        ...
        <tr>
          <td></td>
          <td></td>
          <td width="20%"><fmt:formatNumber value="${totincr}" type="currency" maxFractionDigits="0" /></td>
          <td width="20%"><fmt:formatNumber value="${totdecr}" type="currency" maxFractionDigits="0" /></td>
        </tr>
    </c:if>
