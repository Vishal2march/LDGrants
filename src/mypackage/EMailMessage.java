 ...
 * Name of the file               :  EMailMessage.java
 * Creation/Modification History  :
 *
 * SH   5/8/07      Modified
 * SH   6/8/09  THIS CLASS NO LONGER USED. SEDEMS sends all LDGrants emails.
 * Description
 * This class will handle sending of email messages for the ldgrants system.  It 
 * will store/retrieve info on address to send to, from, and cc, and also the subject
 * and body of email, and has method to send email.  Code was found online and modified
 * to include correct host. 
 *****************************************************************************/
package mypackage;
 ...
 * @version $Id: EMailMessage.java 4689 2009-06-11 14:30:57Z shusak $
...
public class EMailMessage
{
     ...
     */
    public EMailMessage(String h, String t, String f, String s, String b)
    {
                       ...
                       boolean d)
    {
        ...
        cc = (c == null ? null : parseAddressField(c));
    ...
    public boolean send()
    {
        ...
        //props.put("listserv.nysed.gov", host);
